...
export default {
  ...
  methods: {
    ...
    RowClicked(item) {
      this.$router.push({ path: "/shifokor-yonalish-update/" + item.id });
    },
    shifokorBolimiLink(id) {
      return this.$router.push({ path: "shifokor-yonalish-update/" + id });
    },
    createRoomLink() {
      return this.$router.push({ path: "shifokor-yonalish-create" });
    },
    data() {
      let s = this;
