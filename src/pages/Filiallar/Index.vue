                  ...
                  >
                    <div style="display: flex; margin-right: 15px">
                      <b-button
                        ...
                        @click="filiallarLink(row.item.id)"
                        class="pencil"
                      >
                        <b-icon
                          style="width: 15px;"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        "№",
        { key: "name", label: "Филиал", sortable: true },
        { key: "actions", label: "" }
      ],
      translatedFields: [],
      totalRows: 1,
  ...
  methods: {
    ...
    RowClicked(item) {
      this.$router.push({ path: "/filiallar-update/" + item.id });
    },
    filiallarLink(id) {
      return this.$router.push({ path: "/filiallar-update/" + id });
    },
    createRoomLink() {
      return this.$router.push({ path: "/filiallar-create" });
    },
    data() {
      let s = this;
      axios({
