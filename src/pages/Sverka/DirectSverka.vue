    ...
    <div>
      <table class="table table-bordered table-sm table-striped">
        ...
        >
          ...
          <td >
              <span v-if="item.total_kirim > 1" v-for="a of item.regData.registration_inspection">
                {{a.category.name}}
              </span>
              <div v-if="item.total_kirim <= 1">
                {{ item.comment }}
              </div>
          </td>
          <td>
          ...
          <td v-if="item.total_kirim > 1" style="background-color: red; color: #fff;">
            {{ item.total_kirim | numFormat }}
          </td>
          <td v-if="item.total_kirim <= 0" style="background-color: rgb(39, 214, 68); color: #361515;">
