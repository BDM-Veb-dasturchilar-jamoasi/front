<template>
  <div>
    <div class="katta">
      <span>{{ $t("Напровителга Тўловлар") }}</span>
      <button
        ...
        <div class="ustun">
          ...
          <div class="selekt mt-1">
            ...
            <span v-if="errors !== null">
              ...
              <v-select :filter="fuseSearch" id="naprovitel" :options="User" :get-option-label="option => option.name"
                :reduce="option => option.id" v-model="oplata.user_id">
