...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        "№",
        { key: "name", label: "Шифокор кўриги", sortable: true },
        { key: "bolim.name", label: "Шифокор бўлими", sortable: true },
        {
          key: "price",
          label: "Фуқаролик нарҳ",
          sortable: true,
  ...
  methods: {
    ...
    data() {
      ...
      axios({
        method: "get",
        // url: `/doctor_category/all?filial_id=${filial}`
        url: `/doctor_category/all/` + self.JSON.parse(localStorage.getItem("user")).filial_id
