  ...
  <div class="containers">
    ...
    <div class="loginOyna">
      <b-form v-if="show" @submit.prevent style="position: relative;">
        ...
        <div style="text-align: initial; color: #fff;">Филиал танланг</div>
        <v-select
          :options="filial"
          :reduce="options => options.id"
          label="name"
          v-model="form.filial_id"
          @input="handleSelectChange(form.filial_id)"
        />
    ...
    Login() {
      ...
      axios({
        ...
        if (response.data.data.token) {
          ...
          localStorage.setItem("filial_id",  self.form.filial_id);
